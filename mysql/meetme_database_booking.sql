...
CREATE TABLE `booking` (
  ...
  PRIMARY KEY (`id`),
  KEY `BookingScheduleFK_idx` (`scheduleid`),
  CONSTRAINT `BookingScheduleFK` FOREIGN KEY (`scheduleid`) REFERENCES `convenororganiser` (`scheduleid`)
